...
public class CurrentAccountFundTransfer {

    private double transferAmount;
    private int beneficiaryAccountNumber;

    public void initFundTransferToSavingAccount(CurrentAccountHolderDetails loggedInUser, List<SavingsAccountHolderDetails> sbListCopy){
    ...
    public void initFundTransferToCurrentAccount(CurrentAccountHolderDetails loggedInUser, List<CurrentAccountHolderDetails> caListCopy){
        if(scanTransferAmount() < loggedInUser.getAccountBalance()){
            if(scanBeneficiaryAccountNumber()){
